...
This is a [Shopify app](https://shopify.dev/docs/apps/getting-started) using the [Remix](https://remix.run) framework to generate random product and delete all products after fetching every products.
